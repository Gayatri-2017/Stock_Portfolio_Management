...
def kmeans_cal(feature_df,num_clstr,quarter_list,cols,pca_folder,prof_folder,ctr_folder,cluster_folder):
...
num_clstr=4
temp=df.copy()
kmeans_cal(temp,num_clstr,quarter_list,cols,pca_dir,prof_dir,centroid_dir,cluster_dir)
